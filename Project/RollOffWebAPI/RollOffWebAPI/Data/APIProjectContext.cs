...
namespace RollOffWebAPI.Data
{
    public partial class APIProjectContext : DbContext
    {
        public APIProjectContext()
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LIN24006509\\SQLEXPRESS;Initial Catalog=APIProject;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeDatum>(entity =>
            {
                entity.HasKey(e => e.GlobalGroupId)
                    .HasName("PK__Employee__A8B3AC1ADAD703C3");
            ...
            {
                entity.HasKey(e => e.UserId).HasName("PK_UserDetails");
