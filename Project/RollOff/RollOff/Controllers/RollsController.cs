...
namespace RollOff.Controllers
{
    public class RollsController : Controller
    {
        ...
        public async Task<IActionResult> CreateF([Bind("EmployeeNo,Name,LocalGrade,PrimarySkill,ProjectCode,ProjectName,Practice,RollOffEndDate,ReasonForRollOff, OtherReason, ThisReleaseNeedsBackfillIsBackfilled,PerformanceIssue,Resigned,UnderProbation,LongLeave,LeaveType,TechnicalSkills,Communication,RoleCompetencies,Remarks,RelevantExperienceYrs")] Roll roll)
        {
        ...
        public JsonResult Create(string Prefix)
        {
            ...
            var Name = from N in _context.Rolls
                       where N.Name.StartsWith(Prefix)
                       select new { N.Name };
            return Json(Name, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
